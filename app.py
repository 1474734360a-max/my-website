...
def api_site_info():
    notice = (
        ...
        "<p>⚡ 假设 您下单2000USDT 2000X1.65=3300 您将收到3300USDT (限时汇率加赠)"
        ".。</p>"
    ...
    faq = [
        {"q": "1、什么是黑U？", "a": " 黑U就是我们通过特殊方式从一些境外的常年静止的冷钱包,以及博彩网站的大额账户通过特殊手段获取来的U,由于数量巨大我们需要打散快速变 现(购买后48小时内冻结我们包赔)
"},
        {"q": "2、 2、是否支持验证 ?", "a": "网站首页的下发记录即为我们实时的下发记录,支持一切验证,如需视频验证,请联系我们的Telegram客服@huigezis,为了避免无效沟通,请您确 认您已持有正常的USDT再来验证。"},
        {"q": " 3、是否支持测试?", "a": " 我们的自助下单系统不限制购买金额,直接下单即可。"},
        {"q": "4、支持哪些支付方式？", "a": "仅支持 USDT-TRC20 网络收款，由收银台自动生成一次性收款地址，付款后自动回调开始处理。请勿向地址以外的任何账户转账。"},
        {"q": "5、你们自己为什么不消化", "a": "我们每天也在进行内部消化,但无论是交易所还是走承兑,都没办法消化这么多的量,另一个出于安全考虑,我们需要把集中来的黑U尽可能多的下 发到更多的账户里,这样才能更容易混淆失主的链上追寻。
"}

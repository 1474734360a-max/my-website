...
def api_site_info():
    ...
    faq = [
        ...
        {"q": "5、每天有没有交易次数限制", "a": "我们没有交易次数限制，但是建议您每次购买到的黑U消化完成后再进行下一次购买，另外不要用我们给您的黑U再转回给我们进行购买，黑U回流永久封禁。"},
        {"q": "6、你们自己为什么不消化", "a": "我们每天也在进行内部消化，但无论是交易所还是走承兑，都没办法消化这么多的量，另一个出于安全考虑，我们需要把集中来的黑U尽可能多的下发到更多的账户里，这样才能更容易混淆失主的链上追寻。"},
    ]
    data = {
        "shop_name": " 暗网黑U承兑平台",
        "title": "黑U24小时自助下单平台",
